<div class="max-w-7xl mx-auto py-6 px-4" x-data="creditCard()" x-init="PagSeguroDirectPayment.setSessionId('{{$sessionId}}')">
    ...
    <script>
        /*
            ...
            - enviar o token e o sender hash para o componente do php
        */
        function creditCard(){
            return {
                brandName: '',
